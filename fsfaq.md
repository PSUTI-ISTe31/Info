...
### Контрольная работа:
  ...
  - Формат сдачи: сначала отправляем на проверку преподавателю в вк, или лично преподавателю, одобренный/итоговый вариант грузим через систему ДО _(moodle)_, в pdf.
</details>
